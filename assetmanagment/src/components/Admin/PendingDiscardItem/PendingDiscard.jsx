...
import "./pendingDiscard.css";
import { Link, useNavigate } from "react-router-dom";
import QRCode from "qrcode"; // Correct import

const PendingDiscardAsset = () => {
    ...
    return (
        <div className="row">
            <div className="col-md-14">
                ...
                <p>
                    <Link to="/AdminDashboardPage">DashBoard</Link> / <Link to="/PendingDiscardAsset">Discard Asset</Link>
                </p>
...
export default PendingDiscardAsset;
