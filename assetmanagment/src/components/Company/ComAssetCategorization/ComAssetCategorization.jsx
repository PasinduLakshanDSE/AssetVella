...
import "./comassetcategorization.css";
import axios from "axios";
import { Link } from "react-router-dom";

const ComAssetCategorization = () => {
    ...
    <div className="body">
      <div className="asset-categorization">
        <div className="form-container">
          ...
          <p>
            <Link to="/CompanyDashBord">DashBoard</Link> / <Link to="/ComapnyassetCatergorization">Asset Categorization</Link>
          </p>
...
export default ComAssetCategorization;
