...
import "./depCatergory.css";
import axios from "axios";
import { Link } from "react-router-dom";

const DepAssetCategorization = () => {
    ...
    <div className="body">
      <div className="asset-categorization">
        <div className="form-container">
          ...
          <p>
            <Link to="/DepartmentDashBoard">DashBoard</Link> / <Link to="/DepartmentCatergrization">Asset Categorization</Link>
          </p>
...
export default DepAssetCategorization;
